    ...
    <div className='app__hero'>
      <div className='app__hero-content'>
        <div className='app__hero-tagline'>
          ...
          I am a life long learner, polyglot, and hobbyist photographer. I love being crafty taking up new projects ranging from sewing to crochet. 
          {/* <a href="#">Read full about me.</a> */}
          </p>
        </div>
